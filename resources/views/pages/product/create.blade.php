    ...
    <div class="mb-6 bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
        <form action="/product/store" method="POST" enctype="multipart/form-data" class="w-full">
            ...
            <div class="flex flex-col">
                ...
                <div class="w-full mb-4">
                    <label for="stock" class="block text-gray-600 font-semibold mb-2">Stok <span
                            class="text-red-500">*</span></label>
                ...
                <div class="w-full mb-4">
                    <label for="image" class="block text-gray-600 font-semibold mb-2">Gambar <span
                            class="text-red-500">*</span></label>
            ...
            <div class="flex justify-end gap-x-2">
                <button type="submit" class="py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white rounded-md"><i
                        class="ri-add-line"></i> Tambah Produk</button>
