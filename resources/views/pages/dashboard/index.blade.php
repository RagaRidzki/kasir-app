    ...
    <div class="mb-6 gap-6 grid grid-cols-1 md:grid-cols-3">
        <div class="bg-white border-gray-100 shadow-black/5 p-6 rounded-md shadow-md">
            <div class="flex items-center">
                ...
                <h4 class="text-xl font-semibold">100</h4>
            </div>
        </div>
        <div class="bg-white border-gray-100 shadow-black/5 p-6 rounded-md shadow-md">
            <div class="flex items-center">
                <h1 class="text-xl font-semibold mr-2">User:</h1>
                <h4 class="text-xl font-semibold">5</h4>
            </div>
        </div>
        <div class="bg-white border-gray-100 shadow-black/5 p-6 rounded-md shadow-md">
            <div class="flex items-center">
                <h1 class="text-xl font-semibold mr-2">Penjualan:</h1>
                <h4 class="text-xl font-semibold">5000</h4>
            </div>
        </div>
    </div>
</div>
